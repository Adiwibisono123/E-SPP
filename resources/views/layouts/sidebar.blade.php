<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <img src="{{asset('image/logo-skamuhi.png')}}"  height="40px" alt="" srcset="">
        <a href="index.html">E - SPP</a>
      </div>
      <div class="sidebar-brand sidebar-brand-sm">
        {{-- <a href="index.html">E - SPP</a> --}}
        <img src="{{asset('image/logo-skamuhi.png')}}" class="mt-2"  height="40px" alt="" srcset="">
      </div>
      <ul class="sidebar-menu">
          <li class="menu-header">Dashboard</li>
          {{-- <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire mr-2"></i><span>Dashboard</span></a> --}}
          <li class="nav-item">
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
          <a href="http://smkmuhiwlr.sch.id" class="btn btn-primary btn-lg btn-block btn-icon-split">
            <i class="fas fa-rocket"></i> Info Selengkapnya
          </a>
        </div>
    </aside>
  </div>